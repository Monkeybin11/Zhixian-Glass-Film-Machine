...
namespace ProDriver.Auxiliary
{
    ...
    public class HZZHCtrllerAddress
    {
    ...
    /// 汇众智慧控制器与操作句柄集于一体
    /// </summary>
    public class HZZHCtrllerAPIHandle
    {
        /// <summary>
        /// 与控制器通信类
        /// [注:暂时采用Modbus通信]
        ...
        /// <summary>
        /// Modbus通信时单次通信数据单元的个数限值
        /// </summary>
        public int BaseDataCapacityForModbus { private set; get; }
        ...
        /// 错误等级数据单元
        /// </summary>      
        public ProDriver.Auxiliary.HZZHComBaseData ErrorLevelBaseData { private set; get; }

        /// <summary>
        /// 设备运行状态数据单元
        /// [注:设备的运行状态记录在控制器里]
        /// </summary>     
        public ProDriver.Auxiliary.HZZHComBaseData MachineStatusBaseData { private set; get; }
        #endregion
        ...
        private void ResetSpecialBaseData()
        {
            ...
            _specialBaseDataList.Add(ErrorLevelBaseData);
            _specialBaseDataList.Add(MachineStatusBaseData);
        }
    ...
    public class HZZHComBaseData
    {
        ...
        /// 数据是否有效
        /// </summary>
        public bool IsDataValid { set; get; }
