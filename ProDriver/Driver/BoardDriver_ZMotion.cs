...
namespace ProDriver.Driver
{
    ...
    public class BoardDriver_ZMotion : BoardDriver
    {
        ...
        #region 实现抽象函数
        protected override bool DoConnectCtrller(string ip,int port)
        {
            bool rt = false;
            try
            {
        ...
        protected override bool DoDisconnectCtrller()
        {
            bool rt = false;
            try
            {
        ...
        protected override bool DoInitCtrllerSys()
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetBaseAxes(int axisNum, int[] piAxislist)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisType(int naxis, int type)
        {
            bool rt = false;
            try
            {
        ...
        protected override bool DoSetAxisPulseOutMode(int naxis, int mode)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisALMIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoGetAxisALMIn(int naxis, ref int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoSetAxisHRevIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoGetAxisHRevIn(int naxis, ref int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisSRevValue(int naxis, float fvalue)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoSetAxisDatumIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoGetAxisDatumIn(int naxis, ref int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoSetAxisHFwdIn(int naxis, int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="inputno">输入端口位号</param>
        /// <returns></returns>
        protected override bool DoGetAxisHFwdIn(int naxis, ref int inputno)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisSFwdValue(int naxis, float fvalue)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetPortInEffectiveLevel(int inputno, ProCommon.Communal.ElectricalLevel level)
        {
            bool rt = false;
        ...
        /// <returns></returns>
        protected override bool DoSetAxisUnits(int naxis, float units)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisCreep(int naxis, float creep)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisTrapeziumPara(int naxis, float lspeed, float maxspeed, float tacc, float tdec)
        {
            bool rt = false;
        ...
        /// <returns></returns>
        protected override bool DoSetDA(int ionum, float fValue)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisSigmoidPara(int naxis, float lspeed, float maxspeed, float tacc, float tdec, int sacc, int sdec)
        {
            bool rt = false;
        ...
        /// </param>
        /// <returns></returns>
        protected override bool DoFindDatum(int naxis, ProCommon.Communal.MoveDirection moveDir, int mode)
        {
            bool rt = false;
            try
            {
                if (_ghandle.ToInt64() != 0)
                {
                    switch (moveDir)
                    {
                        case ProCommon.Communal.MoveDirection.BackWard:
                            {
                            ...
                            break;
                        case ProCommon.Communal.MoveDirection.ForWard:
                            {
        ...
        /// <returns></returns>
        protected override bool DoSingleContinueMove(int naxis, ProCommon.Communal.MoveDirection movedir)
        {
            bool rt = false;
            int dir = (movedir == ProCommon.Communal.MoveDirection.BackWard) ? -1 : 1;
            try
            {
                if (_ghandle.ToInt64() != 0)
                {
        ...
        /// <returns></returns>
        protected override bool DoSingleRelMove(int naxis, float pos)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSingleAbsMove(int naxis, float pos)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoCancelAxisList(int[] axispos)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSingleCancelMove(int naxis, int mode)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetAxisCurPos(int naxis, float curpos)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="curpos">当前位置</param>
        /// <returns></returns>
        protected override bool DoGetAxisCurPos(int naxis, ref float curpos)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoGetAxisCurspeed(int naxis, ref float curspeed)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoChekcAxisIfStop(int naxis, ref bool stopped)
        {
            bool rt = false;
            int idle = 0;
            try
        ...
        /// <returns></returns>
        protected override bool DoGetAxisStatus(int naxis, ref int axisStatus)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoCheckAxisIfNormal(int naxis, ref bool normal)
        {
            bool rt = false;
            try
            {
        ...
        /// <param name="mode">停止模式，0-当前运动，1-缓存运动，2-当前运动和缓存运动</param>
        /// <returns></returns>
        protected override bool DoRapidStop(int mode)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoLine2Move(float[] axespos, int mode)
        {
            bool rt = false;
            try
            {
        ...
        /// 0-相对位置运动,1-绝对位置运动</param>
        /// <returns></returns>
        protected override bool DoPointsBasedArc2Move(float[] midpos, float[] dstpos, int mode)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoCenterBasedArc2Move(float[] dstpos, float[] cenpos, int dir, int mode)
        {
            bool rt = false;
            try
            {
        ...
        /// 32-倒角</param>
        /// <returns></returns>
        protected override bool DoSetCornerDecelerateMode(int axisNum, int deceleratemode)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetCornerDecelerateAngleRange(int axisNum, float[] decelanglerange)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetCornerDecelerateRadius(int axisNum, float decelradius)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetCornerSoomthRadius(int axisNum, float smoothradius)
        {
            bool rt = false;
            try
            {
        ...
        /// <returns></returns>
        protected override bool DoSetOutBitLogicValue(int nbit, bool onoff)
        {
            bool rt = false;           
        ...
        /// <returns></returns>
        protected bool SetOutBitXValues(ushort nportstart, ushort portnum, uint values)
        {
            bool rt = false;
        ...
        /// <returns></returns>
        protected override bool DoGetOutBitLogicValue(int nbit, ref bool onoff)
        {
            bool rt = false;
            onoff = false;
            uint v = 0;
        ...
        /// <returns></returns>
        protected bool GetOutBitXValues(ushort nportstart, ushort portnum, out byte[] bytearrValue)
        {
            bool rt = false;
        ...
        /// <returns></returns>
        protected override bool DoGetInBitLogicValue(int nbit, ref bool onoff)
        {
            bool rt = false;
            onoff = false;
            uint v = 0;
        ...
        /// <param name="bytearrValue">当前值(字节数组表示)</param>
        /// <returns></returns>
        protected bool GetInBitXValues(int nportstart, int portnum, out byte[] bytearrValue)
        {
            bool rt = false;
            bytearrValue = new byte[4];
            try
        ...
        /// <returns></returns>
        protected override bool DoWaitForAxisFindDatum(int naxis, bool waitfordatum = true, double sleepsecond = 0.01, double timeout = 20, bool enablepause = true, float limitdistance = -1, float specifiedpos = 0.0f)
        {
        ...
        /// <param name="enablepause">允许暂停</param>
        /// <returns></returns>
        protected override bool DoWaitForAxisStop(int naxis, double sleepsecond = 0.01, double timeout = 20, bool enablepause = true)
        {
            bool rt = false;    //正常执行:true,否则false
            System.Diagnostics.Stopwatch stopWatch = new System.Diagnostics.Stopwatch();
            stopWatch.Reset();
        ...
        /// <param name="enablepause">允许暂停</param>
        /// <returns></returns>
        protected override bool DoWaitForAxisLimit(int naxis, LimitType limittype, bool waitforstatus = true, double sleepsecond = 0.01, double timeout = 20, bool enablepause = true)
        {
            bool rt = false;    //正常执行:true,否则false
            System.Diagnostics.Stopwatch stopWatch = new System.Diagnostics.Stopwatch();
            stopWatch.Reset();
        ...
        /// <returns></returns>
        protected override bool DoSetAxisSDEffectiveLevel(int naxis, uint enable, ProCommon.Communal.ElectricalLevel sdlevel, uint sdmode)
        {
            bool rt = false;
        ...
        /// 1,高电平</param>
        /// <returns></returns>
        protected override bool DoSetAxisPCSEffectiveLevel(int naxis, uint enable, ProCommon.Communal.ElectricalLevel pcslevel)
        {
            bool rt = false;
        ...
        /// 1，高电平</param>
        /// <returns></returns>
        protected override bool DoSetAxisINPEffectiveLevel(int naxis, uint enable, ProCommon.Communal.ElectricalLevel inplevel)
        {
            bool rt = false;
        ...
        /// 3,104ms</param>
        /// <returns></returns>
        protected override bool DoSetAxisERCEffectiveLevel(int naxis, uint enable, ProCommon.Communal.ElectricalLevel erclevel, uint ercwidth, uint ercofftime)
        {
            bool rt = false;
        ...
        /// 1,输出ERC信号</param>
        /// <returns></returns>
        protected override bool DoSetAxisERC(int naxis, uint sel)
        {
            bool rt = false;
            try
            {
        ...
        /// 1,减速停止</param>
        /// <returns></returns>
        protected override bool DoSetAxisALMEffectiveLevel(int naxis, ProCommon.Communal.ElectricalLevel almlevel, uint actionmode)
        {
            bool rt = false;
        ...
        /// <returns></returns>
        protected override bool DoSetAxisEZEffectiveLevel(int naxis, ProCommon.Communal.ElectricalLevel ezlevel, uint actionmode)
        {
            bool rt = false;
        ...
        /// <returns></returns>
        protected override bool DoSetAxisLTCEffectiveLevel(int naxis, ProCommon.Communal.ElectricalLevel ltclevel, uint actionmode)
        {
            bool rt = false;
        ...
        /// 3,减速停止,高电平有效</param>
        /// <returns></returns>
        protected override bool DoSetAxisELEffectiveLevel(int naxis, uint actionmode)
        {
            bool rt = false;
            try
            {
        ...
        /// 1,使能</param>
        /// <returns></returns>
        protected override bool DoSetAxisDatumEffectiveLevel(int naxis, ProCommon.Communal.ElectricalLevel datumlevel, uint filter)
        {
            bool rt = false;
        ...
        /// 0-低电平,1-高电平</param>
        /// <returns></returns>
        protected override bool DoSetAxisServo(int naxis, bool onoff)
        {
            bool rt = false;
        ...
        /// 1,高电平</param>
        /// <returns></returns>
        protected override bool DoSetAxisEMGEffectiveLevel(uint enable, ProCommon.Communal.ElectricalLevel emglevel)
        {
            bool rt = false;
