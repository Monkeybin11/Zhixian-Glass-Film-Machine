...
namespace ProVision.Communal
{
    ...
    public class CalibrationSolution : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public CalibrationSolution(ProVision.Communal.CalibrationType calType, string cameraName, string cameraID) : this()
        {
        ...
        /// Row向像素当量
        /// </summary>
        public float RowUnit { set; get; }

        /// <summary>
        /// Col向像素当量
        /// </summary>
        public float ColUnit { set; get; }
    ...
    public class ShapeModelResult
    {
        ...
        public HalconDotNet.HObject GetInstanceContour()
        {
            ...
            if (MatchCount > 0)
            {
                //ModelContour:NCC匹配时没有模板轮廓

                if(ModelContour!=null
                    && ModelContour.IsInitialized())
                {
