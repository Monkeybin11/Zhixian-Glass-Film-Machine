...
namespace ProVision.Calibration
{
    public partial class FrmCalibOnPoint : System.Windows.Forms.Form
    {
        ...
        protected internal virtual void UpdateControl()
        {
            ...
            UpdateLabel(this.lblRPrompt, LanguageVersion, ProVision.Properties.Resources.ResourceManager);
            ...
            UpdateButton(this.btnGetCirclePoint1, LanguageVersion, ProVision.Properties.Resources.ResourceManager);
            UpdateButton(this.btnGoToCirclePoint1, LanguageVersion, ProVision.Properties.Resources.ResourceManager);
            UpdateButton(this.btnGetCirclePoint2, LanguageVersion, ProVision.Properties.Resources.ResourceManager);
            UpdateButton(this.btnGoToCirclePoint2, LanguageVersion, ProVision.Properties.Resources.ResourceManager);
            ...
            this.btnVerifyCalibration.Enabled = false;
        }
                ...
                && chkb.Tag != null)
            {
                switch (chkb.Tag.ToString())
                {
                    ...
                    case "CHKB_ENABLETOOLOFFSET":                       
                        break;
                    case "CHKB_ENABLEVERIDYCROSS":
                        this.btnVerifyCalibration.Enabled = chkb.Checked;
                        break;
                    default: break;
                }
            }
             ...
             && btn.Tag != null)
            {
                ...
                switch (btn.Tag.ToString())
                {
                    ...
                    case "BTN_EXITCALIBRATION":
                        ExitCalibration();
                        break;
                    case "BTN_GETCIRCLEPOINT1":
                        GetPosition(out x, out y, out r);
                        this.numUpDwnCirclePoint1X.Value = Convert.ToDecimal(x);
                        this.numUpDwnCirclePoint1Y.Value = Convert.ToDecimal(y);
                        this.numUpDwnCirclePoint1R.Value = Convert.ToDecimal(r);

                        break;
                    case "BTN_GOTOCIRCLEPOINT1":
                        x = Convert.ToSingle(this.numUpDwnCirclePoint1X.Value);
                        y = Convert.ToSingle(this.numUpDwnCirclePoint1Y.Value);
                        r = Convert.ToSingle(this.numUpDwnCirclePoint1R.Value);
                        GoToPosition(x, y, r);
                        break;
                    case "BTN_GETCIRCLEPOINT2":
                        GetPosition(out x, out y, out r);
                        this.numUpDwnCirclePoint2X.Value = Convert.ToDecimal(x);
                        this.numUpDwnCirclePoint2Y.Value = Convert.ToDecimal(y);
                        this.numUpDwnCirclePoint2R.Value = Convert.ToDecimal(r);
                        break;                   
                    case "BTN_GOTOCIRCLEPOINT2":
                        x = Convert.ToSingle(this.numUpDwnCirclePoint2X.Value);
                        y = Convert.ToSingle(this.numUpDwnCirclePoint2Y.Value);
                        r = Convert.ToSingle(this.numUpDwnCirclePoint2R.Value);
                        GoToPosition(x, y, r);
                        break;
                    default: break;
                }
        ...
        protected internal virtual void CalculateToolOffset()
        {
            ...
            tmpx = Convert.ToSingle(this.numUpDwnCirclePoint1X.Value);
            tmpy = Convert.ToSingle(this.numUpDwnCirclePoint1Y.Value);

            ToolCenterOffsetX = (x - tmpx) / 2.0f;
            ToolCenterOffsetY = (y - tmpy) / 2.0f;

            this.numUpDwnOffsetX.Value = Convert.ToDecimal(ToolCenterOffsetX);
            this.numUpDwnOffsetY.Value = Convert.ToDecimal(ToolCenterOffsetY);
